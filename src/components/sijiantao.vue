  ...
  <div>
    <div class="top_info">
      ...
      <div class="top_info_shop">
        <span class="top_info_shop_title">罗莱家纺全棉纯棉加厚保暖火山磨毛1.8米床四件套冬</span>
      ...
      <div class="next_info_right">
        <el-tabs type="border-card">
          <el-tab-pane label="商品详情" class="remark"
            ><img src="./sijiantao/xiangqing1.jpg" alt=""
          /><img src="./sijiantao/xiangqing2.jpg" alt=""
          /><img src="./sijiantao/xiangqing3.jpg" alt=""
          /><img src="./sijiantao/xiangqing4.jpg" alt=""
          /></el-tab-pane>
...
<script>
import jpg from "@/components/sijiantao/sijiantao.jpg";
export default {
  data() {
    return {
      url: jpg,
