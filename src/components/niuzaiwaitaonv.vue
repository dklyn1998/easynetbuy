  ...
  <div>
    <div class="top_info">
      ...
      <div class="top_info_shop">
        <span class="top_info_shop_title">百搭牛仔拼接短外套女装春秋装2020新款早春季超火cec洋气上衣潮</span>
      ...
      <div class="next_info_right">
        <el-tabs type="border-card">
          <el-tab-pane label="商品详情" class="remark"
            ><img src="./niuzaiwaitaonv/xiangqing1.jpg" alt=""
          /><img src="./niuzaiwaitaonv/xiangqing2.jpg" alt=""
          /><img src="./niuzaiwaitaonv/xiangqing3.jpg" alt=""
          /><img src="./niuzaiwaitaonv/xiangqing4.jpg" alt=""
          /></el-tab-pane>
...
<script>
import jpg from "@/components/niuzaiwaitaonv/niuzaiwaitaonv.jpg";
export default {
  data() {
    return {
      url: jpg,
