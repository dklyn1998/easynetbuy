  ...
  <div>
    <div class="top_info">
      ...
      <div class="top_info_shop">
        <span class="top_info_shop_title">【升级版】supredo尊美堂日常妆容化妆套刷6支装/专业套刷12支装</span>
      ...
      <div class="next_info_right">
        <el-tabs type="border-card">
          <el-tab-pane label="商品详情" class="remark"
            ><img src="./shuanglirendaoju/xiangqing1.jpg" alt=""
          /><img src="./shuanglirendaoju/xiangqing2.jpg" alt=""
          /><img src="./shuanglirendaoju/xiangqing3.jpg" alt=""
          /><img src="./shuanglirendaoju/xiangqing4.jpg" alt=""
          /></el-tab-pane>
...
<script>
import jpg from "@/components/shuanglirendaoju/shuanglirendaoju.jpg";
export default {
  data() {
    return {
      url: jpg,
