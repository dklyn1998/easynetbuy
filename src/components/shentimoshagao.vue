  ...
  <div>
    <div class="top_info">
      ...
      <div class="top_info_shop">
        <span class="top_info_shop_title">洁日本Oh Baby身体磨砂膏 去鸡皮死皮去角质蚕丝精华全身磨砂570g</span>
      ...
      <div class="next_info_right">
        <el-tabs type="border-card">
          <el-tab-pane label="商品详情" class="remark"
            ><img src="./shentimoshagao/xiangqing1.jpg" alt=""
          /><img src="./shentimoshagao/xiangqing2.jpg" alt=""
          /><img src="./shentimoshagao/xiangqing3.jpg" alt=""
          /><img src="./shentimoshagao/xiangqing4.jpg" alt=""
          /></el-tab-pane>
...
<script>
import jpg from "@/components/shentimoshagao/shentimoshagao.jpg";
export default {
  data() {
    return {
      url: jpg,
