  ...
  <div>
    <div class="top_info">
      ...
      <div class="top_info_shop">
        <span class="top_info_shop_title">Vero Moda2020春夏新款复古ins网红风仙女蕾丝连衣裙|32026Z501</span>
      ...
      <div class="next_info_right">
        <el-tabs type="border-card">
          <el-tab-pane label="商品详情" class="remark"
            ><img src="./lianyiqun/xiangqing1.jpg" alt=""
          /><img src="./lianyiqun/xiangqing2.jpg" alt=""
          /><img src="./lianyiqun/xiangqing3.jpg" alt=""
          /><img src="./lianyiqun/xiangqing4.jpg" alt=""
          /></el-tab-pane>
...
<script>
import jpg from "@/components/lianyiqun/lianyiqun.jpg";
export default {
  data() {
    return {
      url: jpg,
