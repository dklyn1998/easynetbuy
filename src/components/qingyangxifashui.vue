  ...
  <div>
    <div class="top_info">
      ...
      <div class="top_info_shop">
        <span class="top_info_shop_title">清扬洗发水露洗头膏水去屑止痒控油持久留香旗舰店官方旗舰男套装</span>
      ...
      <div class="next_info_right">
        <el-tabs type="border-card">
          <el-tab-pane label="商品详情" class="remark"
            ><img src="./qingyangxifashui/xiangqing1.jpg" alt=""
          /><img src="./qingyangxifashui/xiangqing2.jpg" alt=""
          /><img src="./qingyangxifashui/xiangqing3.jpg" alt=""
          /></el-tab-pane>
...
<script>
import jpg from "@/components/qingyangxifashui/pic.jpg";
export default {
  data() {
    return {
      url: jpg,
