      ...
      <div class="next_info_right">
        <el-tabs type="border-card">
          <el-tab-pane label="商品详情" class="remark"
            ><img src="./kouchi/xiangqing1.jpg" alt=""
          /><img src="./kouchi/xiangqing2.jpg" alt=""
          /><img src="./kouchi/xiangqing3.jpg" alt=""
          /><img src="./kouchi/xiangqing4.jpg" alt=""
          /></el-tab-pane>
...
<script>
import jpg from "@/components/kouchi/kouchi.jpg";
export default {
  data() {
    return {
      url: jpg,
