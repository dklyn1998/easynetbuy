  ...
  <div>
    <div class="top_info">
      ...
      <div class="top_info_shop">
        <span class="top_info_shop_title">Levi's李维斯男士新款休闲翻领纯色牛仔长袖衬衫85745-0003
</span>
      ...
      <div class="next_info_right">
        <el-tabs type="border-card">
          <el-tab-pane label="商品详情" class="remark"
            ><img src="./liweisiniuzaiyi/xiangqing1.png" alt=""
          /><img src="./liweisiniuzaiyi/xiangqing2.png" alt=""
          /><img src="./liweisiniuzaiyi/xiangqing3.png" alt=""
          /><img src="./liweisiniuzaiyi/xiangqing4.png" alt=""
          /></el-tab-pane>
...
<script>
import jpg from "@/components/liweisiniuzaiyi/liweisiniuzaiyi.jpg";
export default {
  data() {
    return {
      url: jpg,
