  ...
  <div>
    <div class="top_info">
      ...
      <div class="top_info_shop">
        <span class="top_info_shop_title">TORY BURCH 汤丽柏琦 GEMINI LINK 大号经典印花托特包女包 53303</span>
      ...
      <div class="next_info_right">
        <el-tabs type="border-card">
          <el-tab-pane label="商品详情" class="remark"
            ><img src="./tangbobaiqibao/xiangqing1.png" alt=""
          /><img src="./tangbobaiqibao/xiangqing2.png" alt=""
          /><img src="./tangbobaiqibao/xiangqing3.png" alt=""
          /><img src="./tangbobaiqibao/xiangqing4.png" alt=""
          /></el-tab-pane>
...
<script>
import jpg from "@/components/tangbobaiqibao/tangbobaiqibao.jpg";
export default {
  data() {
    return {
      url: jpg,
