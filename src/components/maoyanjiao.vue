  ...
  <div>
    <div class="top_info">
      ...
      <div class="top_info_shop">
        <span class="top_info_shop_title">SATKI美甲银河猫眼胶宽猫眼新款光疗可卸指甲油胶星空陨石持久胶</span>
      ...
      <div class="next_info_right">
        <el-tabs type="border-card">
          <el-tab-pane label="商品详情" class="remark"
            ><img src="./maoyanjiao/xiangqing1.jpg" alt=""
          /><img src="./maoyanjiao/xiangqing2.jpg" alt=""
          /><img src="./maoyanjiao/xiangqing3.jpg" alt=""
          /><img src="./maoyanjiao/xiangqing4.jpg" alt=""
          /></el-tab-pane>
...
<script>
import jpg from "@/components/maoyanjiao/maoyanjiao.jpg";
export default {
  data() {
    return {
      url: jpg,
