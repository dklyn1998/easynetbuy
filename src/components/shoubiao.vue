  ...
  <div>
    <div class="top_info">
      ...
      <div class="top_info_shop">
        <span class="top_info_shop_title">星空女表</span>
        <span class="top_info_shop_msg">范爷推荐的急救水光炸弹</span>
        ...
        <div class="top_info_shop_total">
          <span>总销量 0</span> <span>累计评论 0</span>
        </div>
      ...
      <div class="next_info_right">
        <el-tabs type="border-card">
          <el-tab-pane label="商品详情" class="remark"
            ><img src="./chenshannv/xiangqing1.jpg" alt=""
          /><img src="./chenshannv/xiangqing2.png" alt=""
          /><img src="./chenshannv/xiangqing3.jpg" alt=""
          /><img src="./chenshannv/xiangqing4.jpg" alt=""
          /></el-tab-pane>
...
<script>
import jpg from "@/components/shoubiao/shoubiao.png";
export default {
  data() {
    return {
      url: jpg,
