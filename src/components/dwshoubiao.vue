  ...
  <div>
    <div class="top_info">
      ...
      <div class="top_info_shop">
        <span class="top_info_shop_title">Daniel Wellington男女dw手表黑色DW手表情侣对表</span>
      ...
      <div class="next_info_right">
        <el-tabs type="border-card">
          <el-tab-pane label="商品详情" class="remark"
            ><img src="./dwshoubiao/xiangqing1.jpg" alt=""
          /><img src="./dwshoubiao/xiangqing2.jpg" alt=""
          /><img src="./dwshoubiao/xiangqing3.jpg" alt=""
          /><img src="./dwshoubiao/xiangqing4.jpg" alt=""
          /></el-tab-pane>
...
<script>
import jpg from "@/components/dwshoubiao/dwshoubiao.jpg";
export default {
  data() {
    return {
      url: jpg,
