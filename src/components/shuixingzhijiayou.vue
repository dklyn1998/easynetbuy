  ...
  <div>
    <div class="top_info">
      ...
      <div class="top_info_shop">
        <span class="top_info_shop_title">可撕拉指甲油女持久免烤快干网红款纯色磨砂哑光无毒无味孕妇可用</span>
      ...
      <div class="next_info_right">
        <el-tabs type="border-card">
          <el-tab-pane label="商品详情" class="remark"
            ><img src="./shuixingzhijiayou/xiangqing1.jpg" alt=""
          /><img src="./shuixingzhijiayou/xiangqing2.jpg" alt=""
          /><img src="./shuixingzhijiayou/xiangqing3.jpg" alt=""
          /></el-tab-pane>
...
<script>
import jpg from "@/components/shuixingzhijiayou/shuixingzhijiayou.jpg";
export default {
  data() {
    return {
      url: jpg,
