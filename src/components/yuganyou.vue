  ...
  <div>
    <div class="top_info">
      ...
      <div class="top_info_shop">
        <span class="top_info_shop_title">COACH蔻驰 TABBY 26号女士单肩斜挎包手提包 76105 73722</span>
      ...
      <div class="next_info_right">
        <el-tabs type="border-card">
          <el-tab-pane label="商品详情" class="remark"
            ><img src="./yuganyou/xiangqing1.jpg" alt=""
          /><img src="./yuganyou/xiangqing2.jpg" alt=""
          /><img src="./yuganyou/xiangqing3.jpg" alt=""
          /><img src="./yuganyou/xiangqing4.jpg" alt=""
          /></el-tab-pane>
...
<script>
import jpg from "@/components/yuganyou/yuganyou.jpg";
export default {
  data() {
    return {
      url: jpg,
