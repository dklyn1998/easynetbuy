  ...
  <div>
    <div class="top_info">
      ...
      <div class="top_info_shop">
        <span class="top_info_shop_title">LG菲诗小铺浪漫邂逅香水沐浴露500ml持久留香滋润保湿男女通用</span>
      ...
      <div class="next_info_right">
        <el-tabs type="border-card">
          <el-tab-pane label="商品详情" class="remark"
            ><img src="./xiangshuimuyulu/xiangqing.gif" alt=""
          /></el-tab-pane>
...
<script>
import jpg from "@/components/xiangshuimuyulu/xiangshuimuyulu.jpg";
export default {
  data() {
    return {
      url: jpg,
