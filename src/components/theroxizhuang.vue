  ...
  <div>
    <div class="top_info">
      ...
      <div class="top_info_shop">
        <span class="top_info_shop_title">Theory 2019秋冬新品男装 羊毛复古格纹西装外套 J0771133</span>
      ...
      <div class="next_info_right">
        <el-tabs type="border-card">
          <el-tab-pane label="商品详情" class="remark"
            ><img src="./theroxizhuang/xiangqing1.jpg" alt=""
          /><img src="./theroxizhuang/xiangqing2.jpg" alt=""
          /><img src="./theroxizhuang/xiangqing3.jpg" alt=""
          /><img src="./theroxizhuang/xiangqing4.jpg" alt=""
          /></el-tab-pane>
...
<script>
import jpg from "@/components/theroxizhuang/theroxizhuang.jpg";
export default {
  data() {
    return {
      url: jpg,
