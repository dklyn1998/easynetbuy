  ...
  <div>
    <div class="top_info">
      ...
      <div class="top_info_shop">
        <span class="top_info_shop_title">sandro2019秋冬新款女装格纹系带长款风衣外套SFPOU00135</span>
      ...
      <div class="next_info_right">
        <el-tabs type="border-card">
          <el-tab-pane label="商品详情" class="remark"
            ><img src="./fengyi/xiangqing1.jpg" alt=""
          /><img src="./fengyi/xiangqing2.jpg" alt=""
          /><img src="./fengyi/xiangqing3.jpg" alt=""
          /><img src="./fengyi/xiangqing4.jpg" alt=""
          /></el-tab-pane>
...
<script>
import jpg from "@/components/fengyi/fengyi.jpg";
export default {
  data() {
    return {
      url: jpg,
