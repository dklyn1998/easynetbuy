  ...
  <div>
    <div class="top_info">
      ...
      <div class="top_info_shop">
        <span class="top_info_shop_title">【直营】韩国进口RYO/吕黄吕防脱乌发固发滋养洗发水 500毫升*3瓶</span>
      ...
      <div class="next_info_right">
        <el-tabs type="border-card">
          <el-tab-pane label="商品详情" class="remark"
            ><img src="./fangtuofaxifashui/xiangqing1.jpg" alt=""
          /><img src="./fangtuofaxifashui/xiangqing2.jpg" alt=""
          /></el-tab-pane>
...
<script>
import jpg from "@/components/fangtuofaxifashui/fangtuofaxifashui.jpg";
export default {
  data() {
    return {
      url: jpg,
