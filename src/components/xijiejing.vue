  ...
  <div>
    <div class="top_info">
      ...
      <div class="top_info_shop">
        <span class="top_info_shop_title">超能洗洁精</span>
      ...
      <div class="next_info_right">
        <el-tabs type="border-card">
          <el-tab-pane label="商品详情" class="remark"
            ><img src="./xijiejing/xiangqing1.jpg" alt=""
          /><img src="./xijiejing/xiangqing2.jpg" alt=""
          /><img src="./xijiejing/xiangqing3.jpg" alt=""
          /></el-tab-pane>
...
<script>
import jpg from "@/components/xijiejing/xijiejing.jpg";
export default {
  data() {
    return {
      url: jpg,
