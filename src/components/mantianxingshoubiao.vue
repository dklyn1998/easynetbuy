  ...
  <div>
    <div class="top_info">
      ...
      <div class="top_info_shop">
        <span class="top_info_shop_title">Armani阿玛尼满天星女表官方正品时尚潮镶钻星空女士手表AR11091</span>
      ...
      <div class="next_info_right">
        <el-tabs type="border-card">
          <el-tab-pane label="商品详情" class="remark"
            ><img src="./mantianxingshoubiao/xiangqing1.jpg" alt=""
          /><img src="./mantianxingshoubiao/xiangqing2.jpg" alt=""
          /><img src="./mantianxingshoubiao/xiangqing3.jpg" alt=""
          /><img src="./mantianxingshoubiao/xiangqing4.jpg" alt=""
          /></el-tab-pane>
...
<script>
import jpg from "@/components/mantianxingshoubiao/mantianxingshoubiao.jpg";
export default {
  data() {
    return {
      url: jpg,
