  ...
  <div>
    <div class="top_info">
      ...
      <div class="top_info_shop">
        <span class="top_info_shop_title">李施德林零度除口臭异味女漱口水便携清洁口腔男清新口气簌口3瓶</span>
      ...
      <div class="next_info_right">
        <el-tabs type="border-card">
          <el-tab-pane label="商品详情" class="remark"
            ><img src="./shukoushui/xiangqing1.jpg" alt=""
          /><img src="./shukoushui/xiangqing2.jpg" alt=""
          /><img src="./shukoushui/xiangqing3.jpg" alt=""
          /><img src="./shukoushui/xiangqing4.jpg" alt=""
          /></el-tab-pane>
...
<script>
import jpg from "@/components/shukoushui/shukoushui.jpg";
export default {
  data() {
    return {
      url: jpg,
