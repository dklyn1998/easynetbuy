      ...
      <div class="next_info_right">
        <el-tabs type="border-card">
          <el-tab-pane label="商品详情" class="remark"
            ><img src="./huazhuangshua/xiangqing1.jpg" alt=""
          /><img src="./huazhuangshua/xiangqing2.jpg" alt=""
          /><img src="./huazhuangshua/xiangqing3.jpg" alt=""
          /><img src="./huazhuangshua/xiangqing4.jpg" alt=""
          /></el-tab-pane>
...
<script>
import jpg from "@/components/huazhuangshua/huazhuangshua.jpg";
export default {
  data() {
    return {
      url: jpg,
