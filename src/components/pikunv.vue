  ...
  <div>
    <div class="top_info">
      ...
      <div class="top_info_shop">
        <span class="top_info_shop_title">edition高腰绵羊皮皮裤女秋款褶裥系腰带萝卜裤EA183LET004 moco</span>
      ...
      <div class="next_info_right">
        <el-tabs type="border-card">
          <el-tab-pane label="商品详情" class="remark"
            ><img src="./pikunv/xiangqing1.jpg" alt=""
          /><img src="./pikunv/xiangqing2.jpg" alt=""
          /><img src="./pikunv/xiangqing3.jpg" alt=""
          /><img src="./pikunv/xiangqing4.jpg" alt=""
          /></el-tab-pane>
...
<script>
import jpg from "@/components/pikunv/pikunv.jpg";
export default {
  data() {
    return {
      url: jpg,
