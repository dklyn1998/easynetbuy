  ...
  <div>
    <div class="top_info">
      ...
      <div class="top_info_shop">
        <span class="top_info_shop_title">洁柔抽纸 Face系列餐巾纸卫生纸3层120抽整箱40包</span>
      ...
      <div class="next_info_right">
        <el-tabs type="border-card">
          <el-tab-pane label="商品详情" class="remark"
            ><img src="./jierouzhijin/xiangqing1.jpg" alt=""
          /><img src="./jierouzhijin/xiangqing2.jpg" alt=""
          /><img src="./jierouzhijin/xiangqing3.jpg" alt=""
          /><img src="./jierouzhijin/xiangqing4.jpg" alt=""
          /></el-tab-pane>
...
<script>
import jpg from "@/components/jierouzhijin/jierouzhijin.jpg";
export default {
  data() {
    return {
      url: jpg,
