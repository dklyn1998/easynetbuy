  ...
  <div>
    <div class="top_info">
      ...
      <div class="top_info_shop">
        <span class="top_info_shop_title">白鹅绒羽绒枕头家用全棉成人五星级酒店枕单人双人颈椎软枕芯一对</span>
      ...
      <div class="next_info_right">
        <el-tabs type="border-card">
          <el-tab-pane label="商品详情" class="remark"
            ><img src="./xierdunzhentou/xiangqing1.jpg" alt=""
          /><img src="./xierdunzhentou/xiangqing2.jpg" alt=""
          /><img src="./xierdunzhentou/xiangqing3.jpg" alt=""
          /><img src="./xierdunzhentou/xiangqing4.jpg" alt=""
          /></el-tab-pane>
...
<script>
import jpg from "@/components/xierdunzhentou/xierdunzhentou.png";
export default {
  data() {
    return {
      url: jpg,
