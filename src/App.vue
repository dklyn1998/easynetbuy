  ...
  <div id="app">
    <el-container direction="vertical">
      <el-header height="195px">
        <el-row :gutter="20" type="flex" justify="center" align="middle" class="header_info">
          <el-col :span="3.5" class="col_list">
            <el-link :underline="false" type="info" href='/'>首页</el-link>
          </el-col>
          <el-col :span="3.5" class="col_list">
            <el-link :underline="false" type="info" href='/about'>关于我们</el-link>
          </el-col>
          <el-col :span="3.5" class="col_list">
            <el-link :underline="false" type="info" @click="dialogbookVisible = true">我的订单</el-link>
          </el-col>
          <el-col :span="3.5" class="col_list">
            <el-link :underline="false" type="info" @click="dialogcartVisible = true">购物车</el-link>
          </el-col>
          <el-col :span="1.5" :offset="5" class="col_list">
            <el-link :underline="false" type="info" @click="dialogLogVisible = true">登录</el-link>
          </el-col>
          <el-col :span="1.5" class="col_list">
            <el-link :underline="false" type="info" @click="dialogRegVisible = true">注册</el-link>
          </el-col>
        </el-row>
        <el-dialog title="登录" :visible.sync="dialogLogVisible" center>
          ...
          <div slot="footer" class="dialog-footer">
            ...
            <el-button type="primary" @click="dialogLogVisible = false">登 录</el-button>
          </div>
        </el-dialog>
        <el-dialog title="注册" :visible.sync="dialogRegVisible" center>
          ...
          <div slot="footer" class="dialog-footer">
            ...
            <el-button type="primary" @click="dialogRegVisible = false">登 录</el-button>
          </div>
        </el-dialog>
        <el-dialog title="查看购物车" :visible.sync="dialogcartVisible" width='750px' center>
        ...
        <el-dialog title="查看订单" :visible.sync="dialogbookVisible" width='750px' center>
          <div class="dialog_cart">
            <div><img src=".\assets\cart.png" alt=""></div>
            <span>您的订单空空如也</span>
            <span>赶紧行动吧</span>
        ...
        <!-- 下方logo栏和搜索栏 -->
        <el-row class="logo_search" :gutter="20" type="flex" justify="space-between" align="middle">
          <el-col><img src="./assets/logo.png" alt="好买网" /></el-col>
          <el-col :span="6" class="search_button">
            <el-input placeholder="请输入内容" prefix-icon="el-icon-search" v-model="inputInfo" clearable>
            </el-input>
            <el-button type="danger" round class="button_search">搜索</el-button>
          </el-col>
        </el-row>
        <!-- 下方的导航条 -->
        <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect"
          background-color="#FF3366" text-color="#fff" active-text-color="#fff" router>
          <el-submenu index="1">
            <template slot="title">
              <span class="iconfont icon-fenlei"> 商城分类</span></template>
            <el-submenu index="1-1">
              <template slot="title"><span class="iconfont icon-shafa"> 家居个护</span></template>
            ...
            <el-submenu index="1-2">
              <template slot="title"><span class="iconfont icon-nvzhuangqunzi-">
                  女装</span></template>
            ...
            <el-submenu index="1-3">
              <template slot="title"><span class="iconfont icon-daocha"> 美食生鲜</span></template>
            ...
            <el-submenu index="1-4">
              <template slot="title"><span class="iconfont icon-yingerche"> 母婴</span></template>
            ...
            <el-submenu index="1-5">
              <template slot="title"><span class="iconfont icon-nanzhuang"> 男装</span></template>
            ...
            <el-submenu index="1-6">
              <template slot="title"><span class="iconfont icon-xiexiangbao"> 箱包</span></template>
            ...
            <el-submenu index="1-7">
              <template slot="title"><span class="iconfont icon-kouhong"> 美妆</span></template>
      ...
      <el-footer height="200px">
        <el-row :gutter="20" type="flex" justify="center" align="middle" style="font-size: 20px" class="footer_margin">
          <el-col :span="4">购物指南</el-col>
          <el-col :span="4">购物保障</el-col>
          <el-col :span="4">支付方式</el-col>
          <el-col :span="4">商家服务</el-col>
        </el-row>
        <el-row :gutter="20" type="flex" justify="center" align="middle" class="footer_margin">
