  ...
  <div id="app">
    <el-container direction="vertical">
      <el-header height="195px">
        ...
        >
          <el-col :span="3.5" class="col_list">
            <el-link :underline="false" type="info">首页</el-link></el-col
          >
          <el-col :span="3.5" class="col_list">
            <el-link :underline="false" type="info">关于我们</el-link>
          </el-col>
          <el-col :span="3.5" class="col_list">
          ...
          <el-col :span="1.5" :offset="5" class="col_list">
            <el-link :underline="false" type="info">登录</el-link>
          </el-col>
          <el-col :span="1.5" class="col_list">
            <el-link :underline="false" type="info">注册</el-link>
          </el-col>
        </el-row>
        <!-- 下方logo栏和搜索栏 -->
        <el-row
        ...
        >
          ...
          <el-menu-item index="3">每日推荐</el-menu-item>
          <el-menu-item index="4">品质生活</el-menu-item>
          <el-menu-item index="5">热卖好货</el-menu-item>
          <el-menu-item index="6">优惠专区</el-menu-item>
          <el-menu-item index="7">分销加盟</el-menu-item>
        </el-menu>
      </el-header>
      <el-main>
      ...
      <el-footer height="200px">
        ...
        <el-row class="footer_right"><el-col>Copyright © Company 段珂毕业设计 All rights reserved</el-col></el-row>
      </el-footer>
    </el-container>
  </div>
</template>
